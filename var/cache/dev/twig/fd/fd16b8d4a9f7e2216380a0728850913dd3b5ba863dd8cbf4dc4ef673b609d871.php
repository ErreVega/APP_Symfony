...
/* profile.html.twig */
class __TwigTemplate_176a9461a69d700cd042206978acc06a286dc4caee038c8874c9b72b696894fc extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 5
        echo "    <img class=\"image right-align table-bordered m-3\" src=\" + ";
        echo twig_escape_filter($this->env, (isset($context["photo_path"]) || array_key_exists("photo_path", $context) ? $context["photo_path"] : (function () { throw new RuntimeError('Variable "photo_path" does not exist.', 5, $this->source); })()), "html", null, true);
        echo " \" alt=\"Foto\" width=\"250px\">
    <div class=\"content m-3\">
    <div class=\"flex-container left-align\">
           <div>Nombre  ";
        // line 8
        echo twig_escape_filter($this->env, (isset($context["user_name"]) || array_key_exists("user_name", $context) ? $context["user_name"] : (function () { throw new RuntimeError('Variable "user_name" does not exist.', 8, $this->source); })()), "html", null, true);
        echo " </div>
        </div>
    <br>
    <div class=\"flex-container left-align\">
    ...
    <div class=\"flex-container left-align\">
           <div>Dirección  ";
        // line 20
        echo twig_escape_filter($this->env, (isset($context["address"]) || array_key_exists("address", $context) ? $context["address"] : (function () { throw new RuntimeError('Variable "address" does not exist.', 20, $this->source); })()), "html", null, true);
        echo "  </div>
        </div>
    </div>
    <br>
    ...
    ";
        // line 25
        if (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 25, $this->source); })()), "user", [], "any", false, false, false, 25), "userid", [], "any", false, false, false, 25), (isset($context["consulted_user_id"]) || array_key_exists("consulted_user_id", $context) ? $context["consulted_user_id"] : (function () { throw new RuntimeError('Variable "consulted_user_id" does not exist.', 25, $this->source); })()))) {
            // line 26
            echo "        <br><br><br><br>
...
";
    ...
    {
        return array (  132 => 29,  127 => 26,  125 => 25,  117 => 20,  110 => 16,  103 => 12,  96 => 8,  89 => 5,  79 => 4,  59 => 3,  36 => 1,);
    }
