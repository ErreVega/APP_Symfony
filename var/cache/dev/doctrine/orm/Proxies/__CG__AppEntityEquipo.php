 ...
 */
class Equipo extends \App\Entity\Equipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Equipo' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Equipo' . "\0" . 'nombre', '' . "\0" . 'App\\Entity\\Equipo' . "\0" . 'fundacion', '' . "\0" . 'App\\Entity\\Equipo' . "\0" . 'socios', '' . "\0" . 'App\\Entity\\Equipo' . "\0" . 'ciudad'];
        }
